...
function _precompile_()
    ...
    # from snooping plots with Plots.jl with the GR examples
    ...
    precompile(Tuple{typeof(GR.grid3d), Float64, Int64, Int64, Float64, Float64, Float64, Int64, Int64, Int64})
    ...
    precompile(Tuple{typeof(GR.grid3d), Int64, Int64, Float64, Float64, Float64, Float64, Int64, Int64, Int64})
    ...
    # from snooping a plot using only GR
    ...
    precompile(Tuple{typeof(GR.js.inject_js)})
    ...
    precompile(Tuple{typeof(GR.GR3.volume), Array{Float64, 3}, Int64})
    precompile(Tuple{typeof(GR.js.jsterm_send), String})
    ...
    precompile(Tuple{typeof(GR.init), Bool})
    precompile(Tuple{typeof(GR.jlgr.RGB), UInt32})
    ...
    precompile(Tuple{typeof(GR.jlgr.given), Type{Int}})
    precompile(Tuple{typeof(GR.isijulia)})
    precompile(Tuple{typeof(GR.plot), Array{Float64, 1}, Array{Float64, 1}})
    ...
    precompile(Tuple{typeof(GR.jlgr.plot), Array{Float64, 1}, Array{Float64, 1}})
